const Handwriting = function(cvs, lineWidth) {
  this.canvas = cvs;
 ...
 */
Handwriting.prototype.set_Undo_Redo = function(undo, redo) {
  this.allowUndo = undo;
...
Handwriting.prototype.setLineWidth = function(lineWidth) {
  this.lineWidth = lineWidth;
};

Handwriting.prototype.setCallBack = function(callback) {
  this.callback = callback;
};

Handwriting.prototype.setOptions = function(options) {
  this.options = options;
};

Handwriting.prototype.mouseDown = function(e) {
  // new stroke
...
Handwriting.prototype.mouseMove = function(e) {
  if (this.drawing) {
    var rect = this.canvas.getBoundingClientRect();
    var x = e.clientX - rect.left;
    var y = e.clientY - rect.top;
...
Handwriting.prototype.mouseUp = function() {
  var w = [];
...
Handwriting.prototype.touchStart = function(e) {
  e.preventDefault();
  this.cxt.lineWidth = this.lineWidth;
  this.handwritingX = [];
  this.handwritingY = [];
...
Handwriting.prototype.touchMove = function(e) {
  e.preventDefault();
...
Handwriting.prototype.touchEnd = function(e) {
  var w = [];
  w.push(this.handwritingX);
  w.push(this.handwritingY);
  w.push([]);
...
Handwriting.prototype.undo = function() {
...
Handwriting.prototype.redo = function() {
...
Handwriting.prototype.erase = function() {
  this.cxt.clearRect(0, 0, this.width, this.height);
  this.step = [];
  this.redo_step = [];
  this.redo_trace = [];
...
Handwriting.recognize = function(trace, options, callback) {
  if (Handwriting && this instanceof Handwriting) {
    trace = this.trace;
